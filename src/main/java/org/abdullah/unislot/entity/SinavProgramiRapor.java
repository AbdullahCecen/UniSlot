...
public class SinavProgramiRapor {
    ...
    public void setYariyil(Integer yariyil) {
    ...
    public Integer getAyrilanKapasite() {
        return ayrilanKapasite;
    }

    public void setAyrilanKapasite(Integer ayrilanKapasite) {
        this.ayrilanKapasite = ayrilanKapasite;
    }
}